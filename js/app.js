...
var app = new Framework7({
  ...
  routes: [
    ...
    {
      path: "/alfalvi-templom/",
      url: "pages/pages/single_curch.html",
    },
    {
      path: "/sugo-barlang/",
      url: "pages/pages/sugo_barlang.html",
    },
    {
      path: "/lazar-kastely/",
      url: "pages/pages/lazar_kastely.html",
    },
    {
      path: "/szent-anna-to/",
      url: "pages/pages/szent_anna.html",
    },
    {
      path: "/medve-to/",
      url: "pages/pages/medve_to.html",
    },
    {
      path: "/csiksomlyoi-templom/",
      url: "pages/pages/csik_temp.html",
    },
    {
      path: "/gyilkos-to/",
...
$$(document).on(
  "page:init",
  '.page[data-name="infinite-scroll"]',
  function (e) {
    ...
    $$(".infinite-scroll-content").on("infinite", function () {
      ...
      setTimeout(function () {
        ...
        var html = "";
        for (
          var i = lastItemIndex + 1;
          i <= lastItemIndex + itemsPerLoad;
          i++
        ) {
          html +=
...
$$(document).on(
  "page:init",
  '.page[data-name="pull-to-refresh"]',
  function (e) {
